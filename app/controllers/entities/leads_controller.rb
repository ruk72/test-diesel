  ...
  def create
    ...
    respond_with(@lead) do |format|
      if @lead.save_with_permissions(params)
        selected_day = params[:ti_vin]['payoff_good_till(1i)'].to_i
        selected_month = params[:ti_vin]['payoff_good_till(2i)'].to_i
        selected_year = params[:ti_vin]['payoff_good_till(3i)'].to_i
  ...
  def update
    respond_with(@lead) do |format|
      if @lead.update_with_permissions(params[:lead], params[:users])
            puts selected_day = params[:ti_vin]['payoff_good_till(1i)'].to_i
           puts  selected_month = params[:ti_vin]['payoff_good_till(2i)'].to_i
            puts selected_year = params[:ti_vin]['payoff_good_till(3i)'].to_i
